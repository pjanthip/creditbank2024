...
<div class='container'> 
    <div class='panel panel-default'>
        <div class='panel-heading'>
          <h3 class='panel-title'>แก้ไขข้อมูล $table</h3>
        </div>
        ...
        if (!in_array($field, $fix_no_show2)) {
            echo htmlspecialchars("
                <div class='form-group'>           
                    ...
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' id='$field' name='$field' value=\"<?php echo \$rsData['$field'];?>\" >                            
                    </div>        
                </div>\n");
        }
    }
    ...
    <div class='modal-dialog'>
      <div class='modal-content'>
        <div class='modal-header'>
          ...
          <h4 class='modal-title' id='myModalLabel'>บันทึกข้อมูลการแก้ไข</h4>
        </div>
        <div class='modal-body'>
              <h4>ยืนยันการบันทึกข้อมูลการแก้ไข ?</h4>       
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#btnSave').click(function() {            
            ...
            var faction = '<?php echo site_url('path_name/$table/update');?>';
    ...
    function loadPage() {
            ...
            //$(\"#ObjectID).val(\"< ?php echo \$rsData['ID'];?>\");
     }
</script>
