<div class="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header font-weight-bold font-18 bg-teacher2 text-white"><i class="fas fa-user mr-2"></i>ข้อมูลส่วนตัวของผู้สอน</div>
                    <div class="card-body font-18">
                        <form  id="profileForm" name="profileForm" role="form" accept-charset="utf-8" method="post" action="<?php echo site_url('tis/profile/update_profile'); ?>">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="coordinator_fname" name="coordinator_fname" class="form-control" placeholder="ชื่อ" value="<?php echo $data->teacher_fname;?>">
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" id="coordinator_lname" name="coordinator_lname" class="form-control" placeholder="สกุล" value="<?php echo $data->teacher_lname;?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" id="rank_id" name="rank_id" class="form-control" placeholder="ตำแหน่ง" value="<?php echo $data->prefix_name_full_th;?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="coordinator_tel" name="coordinator_tel" class="form-control" placeholder="เบอร์โทร" value="<?php echo $data->teacher_tel;?>">
                                    </div>
                                    <div class="col-md-7">
                                        <input type="text" id="coordinator_email" name="coordinator_email" class="form-control" placeholder="E-mail" value="<?php echo $data->teacher_email;?>">
                                    </div>
                                </div>
                            </div>
