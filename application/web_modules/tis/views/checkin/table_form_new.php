...
<input type="hidden" name="typefrm" id="typefrm" value="new"/>
            ...
            ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <div class="radio-list row">
                                <div class="col-2 custom-control custom-radio">
                                    <input type="radio" id="1-coming-<?php echo $data->learner_code; ?>" name="1-learner_<?php echo $data->learner_code; ?>" value="1" onchange="javascript:close_leave_note('<?php echo $data->learner_code; ?>',1);" class="form-check-input radio-1 coming-1">
                                    <label class="form-check-label text-success" for="1-coming-<?php echo $data->learner_code; ?>">มา</label>
                                </div>
                                <div class="col-2 custom-control custom-radio">
                                    <input type="radio" id="1-absent-<?php echo $data->learner_code; ?>" name="1-learner_<?php echo $data->learner_code; ?>" value="0" onchange="javascript:close_leave_note('<?php echo $data->learner_code; ?>',1);" class="form-check-input radio-1">
                                ...
                                <div class="col-8  custom-control custom-radio">
                                    <div class="row">
                                        <div class="col-4">
                                            <input type="radio" id="1-leave-<?php echo $data->learner_code; ?>" name="1-learner_<?php echo $data->learner_code; ?>" value="2" onchange="javascript:leave_note('<?php echo $data->learner_code; ?>',1);" class="form-check-input radio-1">
                                            <label class="form-check-label text-danger" for="1-leave-<?php echo $data->learner_code; ?>">ลา</label>
                                        </div>
                                        <div class="col-8">
                                            <input type="text" name="1-note_<?php echo $data->learner_code; ?>" id="1-leave-note-<?php echo $data->learner_code; ?>" class="form-control note-1" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <td class="text-center">
                            ...
                            <div class="radio-list row">
                                <div class="col-2 custom-control custom-radio">
                                    <input type="radio" id="2-coming-<?php echo $data->learner_code; ?>" name="2-learner_<?php echo $data->learner_code; ?>" value="1" onchange="javascript:close_leave_note('<?php echo $data->learner_code; ?>',2);" class="form-check-input radio-2 coming-2">
                                    <label class="form-check-label text-success" for="2-coming-<?php echo $data->learner_code; ?>">มา</label>
                                </div>
                                <div class="col-2 custom-control custom-radio">
                                    <input type="radio" id="2-absent-<?php echo $data->learner_code; ?>" name="2-learner_<?php echo $data->learner_code; ?>" value="0" onchange="javascript:close_leave_note('<?php echo $data->learner_code; ?>',2);" class="form-check-input radio-2">
                                    <label class="form-check-label text-warning" for="2-absent-<?php echo $data->learner_code; ?>">ขาด</label>
                                </div>
                                <div class="col-8  custom-control custom-radio">
                                    <div class="row">
                                        <div class="col-4">
                                            <input type="radio" id="2-leave-<?php echo $data->learner_code; ?>" name="2-learner_<?php echo $data->learner_code; ?>" onchange="javascript:leave_note('<?php echo $data->learner_code; ?>',2);" value="2" class="form-check-input radio-2">
                                            <label class="form-check-label text-danger" for="2-leave-<?php echo $data->learner_code; ?>">ลา</label>
                                        </div>
                                        <div class="col-8">
                                            <input type="text" name="2-note_<?php echo $data->learner_code; ?>" id="2-leave-note-<?php echo $data->learner_code; ?>" class="form-control note-2" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
