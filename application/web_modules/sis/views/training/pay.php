            ...
            <div class="row">
                ...
                <div class="col-sm-12 ">
                    <div class="card col-md-12">
                        ...
                        <div class="card-body text-center">
                            <form class="form-horizontal" id="postForm" name="postForm" role="form" accept-charset="utf-8" method="post" action="<?php echo site_url('sis/pay/save_register_pay'); ?>" enctype="multipart/form-data">
                                <input type="hidden" name="training_member_id" id="training_member_id"
                                    value="<?php echo $training->training_member_id?>">
                                    <input type="hidden" name="training_register_id" id="training_register_id"
                                    value="<?php echo $training_register_id?>">
...
function processJson(response) {
    ...
    if (response.status == true) {
        $.ajax({
                        type: "POST",
                        url: "<?php echo site_url('website/register/line_notify') ?>",
                        data: {
                            id: response.id,
                            function: 'pay'
                        },
        ...
        setTimeout(() => {
            ...
            window.location.href="<?php echo site_url('sis/training/register');?>";
        }, 500);
    } else {
