        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
            <div class="card py-0 px-0">
                <div class="card-header text-center ">
                    ...
                    <h3 class="text-center pt-2 text-white">Learner Information System (LIS)</h3>
                </div>
                <p class="text-center mb-4 mt-0">เข้าสู่ระบบบริการข้อมูลนักศึกษา</p>
                <form class="myform" id="loginform" method="post" action="<?php echo site_url('sis/login/signin')?>">
                    <div class="form-group mb-2"> <input type="textbox" name="learner_id" id="learner_id" class="form-control text-white" placeholder="รหัสนักศึกษา" value=""> </div>
                    <div class="form-group mb-2"> <input type="password" name="password" id="password" class="form-control text-white" placeholder="รหัสผ่าน" value=""> </div>
                    <div class="row mb-4">
                    ...
                    <div class="form-group mt-3"> <button type="submit" class="btn btn-block btn-primary btn-lg"><small><i class="far fa-user pr-2"></i>เข้าสู่ระบบ</small></button> </div>
...
.card {
    ...
    border-top: 5px solid rgb(0, 139, 206);
    background: #212042;
    color: #57557A
}
