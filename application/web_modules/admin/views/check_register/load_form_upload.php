...
?>
<form class="form-horizontal" id="postForm" name="postForm" role="form" accept-charset="utf-8" method="post" action="<?php echo site_url('admin/check_register/update_document'); ?>">
