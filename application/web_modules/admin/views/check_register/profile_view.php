<div class="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="mb-4 row pl-2">
            <form action="<?php echo site_url('admin/check_register')?>" method="post" id="fback">
                <input type="hidden" name="curriculum" id="curriculum" value="<?php echo $cid;?>"/>
                <!--<button type="button" id="bt-back-curri" class="btn btn-dark d-lg-block text-white"><i class="fas fa-arrow-left"></i> ย้อนกลับ</button>-->
                <a href="<?php echo site_url('admin/check_register');?>" id="bt-back-curri" class="btn btn-dark d-lg-block text-white"><i class="fas fa-arrow-left"></i> ย้อนกลับ</a>
            </form>
        </div>
                            ...
                            <table class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php
                                                if($row->document_file_name!=""){
                                                    ...
                                                    echo '<a href="'.base_url('assets/document/'.$row->document_file_name).'" '.$lightbox.' target="_blank" class="'.$color.'">'.$icon.'</a>';
                                                }
                                            ?>
                                        </td>
                                        <td class="text-center">
                                        ...
                                        <td class="text-center <?php echo ($row->document_reason_id==3)? "text-success":"text-warning";?>"><?php echo getLabelStatusDocument($row->document_reason_id);?></td>
                                        <td class="text-center">
                                            <?php
                                            //echo do_date_name_st1($row->document_update);
...
<script>
    ...
    function check_doc(id){
        ...
        $.post("<?php echo site_url('admin/check_register/load_form_upload')?>", param, function(res) {
