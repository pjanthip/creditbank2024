<div class="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header text-center bg-dark"><h4 class="font-weight-bold m-b-0 text-white">รายชื่อผู้สมัคร (<?php echo $qty_regsiter?>/25)</h4></div>
                    <div class="card-body">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <a href="<?php echo site_url('admin/register/export_register_v5');?>" class="btn btn-success" target="_blank" ><i class="fa-solid fa-download"></i> Download รายชื่อผู้สมัคร</a>
                        <div class="table-responsive m-t-20">
                            <table id="table-member" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                            $sql = "SELECT * FROM tb_register_member_66 INNER JOIN tb_prefix_name ON tb_register_member_66.prefix_name_id = tb_prefix_name.prefix_name_id
                                                    WHERE
                                                    tb_register_member_66.curriculum_id = '$curriculum_id' AND
                                                    `register_datetime_record` >= '2023-09-01 00:00:00' AND
                                                    `register_datetime_record` <= '2023-10-11 23:59:59'
                                                    ORDER BY
                                            ...
                                            foreach ($register as $member) {
                                                ...
                                                if($member->register_status == 2){
                                                    $sql_1 = "SELECT document_id FROM tb_document_66 WHERE register_member_id = '".$member->register_member_id."' AND document_reason_id = 1";
                                                    $chk_status_1 = $this->db->query($sql_1)->num_rows();
                                                    $sql_2 = "SELECT document_id FROM tb_document_66 WHERE register_member_id = '".$member->register_member_id."' AND document_reason_id = 2";
                                                    $chk_status_2 = $this->db->query($sql_2)->num_rows();
                                                    $sql_3 = "SELECT document_id FROM tb_document_66 WHERE register_member_id = '".$member->register_member_id."' AND document_reason_id = 3";
                                                ...
                                                echo    '<tr>
                                                            ...
                                                            <td class="text-center align-middle">
                                                                <form id="form-'.$member->register_member_id.'" action="'.site_url('admin/register/profile66_v5').'" method="post">
