<div class="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header text-center bg-dark"><h4 class="font-weight-bold m-b-0 text-white">รายชื่อผู้สมัคร</h4></div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    <?php
                                            $sql = "SELECT * FROM tb_register_member INNER JOIN tb_prefix_name ON tb_register_member.prefix_name_id = tb_prefix_name.prefix_name_id
                                                    WHERE
                                                    tb_register_member.curriculum_id = '$curriculum_id'
                                                    ORDER BY
                                            ...
                                            foreach ($register as $member) {
                                                ...
                                                echo    '<tr>
                                                            ...
                                                            <td class="text-center align-middle">
                                                                <form id="form-'.$member->register_member_id.'" action="'.site_url('admin/register/profile').'" method="post">
