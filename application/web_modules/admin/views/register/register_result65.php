<div class="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header text-center bg-dark"><h4 class="font-weight-bold m-b-0 text-white">รายชื่อผู้สมัคร (<?php echo $qty_regsiter?>/60)</h4></div>
                    <div class="card-body">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <a href="<?php echo site_url('admin/register/export_register65');?>" class="btn btn-success" target="_blank" ><i class="fa-solid fa-download"></i> Download รายชื่อผู้สมัคร</a>
                                ...
                                <tbody>
                                    <?php
                                            $sql = "SELECT * FROM tb_register_member INNER JOIN tb_prefix_name ON tb_register_member.prefix_name_id = tb_prefix_name.prefix_name_id
                                                    ...
                                                    `register_datetime_record` >= '2022-03-01' AND
                                                    `register_datetime_record` <= '2022-03-31'
                                                    ORDER BY
