                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo site_url('admin/teacher/grade_input')?>" class="btn btn-sm btn-facebook waves-effect btn-circle waves-light" type="button"> <i class="far fa-edit"></i>เลือก </a>
                                        </td>
                                    </tr>
                                    <tr>
