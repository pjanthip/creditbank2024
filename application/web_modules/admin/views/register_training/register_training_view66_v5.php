                                ...
                                <tbody>
                                    ...
                                    $cc=1;
                                        foreach ($register as $data) {
                                            ...
                                            $sql = "SELECT * FROM tb_training_member_66 WHERE training_register_id = '$data->training_register_id' ORDER BY training_member_id ASC";
                                            $qtyMember_training = $this->db->query($sql)->num_rows();
                                            $sql = "SELECT * FROM tb_register_member_66 WHERE curriculum_id = 'C00001' AND register_status <> 0  AND register_datetime_record >= '2023-09-01 00:00:00' AND register_datetime_record <= '2023-10-11 23:59:59'";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="mb-2"><strong class="text-primary">ระยะเวลาสมัคร :</strong> <?php echo format_datetimeshot($data->training_register_datetime_start);?> - <?php echo format_datetimeshot($data->training_register_datetime_end);?> <?php check_intime($data->training_register_datetime_start,$data->training_register_datetime_end);?></div>
                                            <div class="mb-2"><strong class="text-primary">ระยะเวลาชำระเงิน :</strong> <?php echo format_datetimeshot($data->training_register_pay_start);?> - <?php echo format_datetimeshot($data->training_register_pay_end);?> <?php check_intime($data->training_register_pay_start,$data->training_register_pay_end);?></div>
                                        ...
                                        <td class="text-center">
                                            <form id="form-<?php echo $data->training_register_id;?>" action="<?php echo site_url('admin/register_training/result66_v5');?>" method="post">
