<div class="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="mb-4 row pl-2">
            <a href="<?php echo site_url('admin/register_training/training66_v5');?>" class="btn btn-dark d-lg-block text-white"><i class="fas fa-arrow-left" aria-hidden="true"></i> ย้อนกลับ</a>
        </div>
...
<script>
        ...
        function getSlip(id,slip_name){
            ...
            $.post("<?php echo site_url('admin/register_training/getSlip_v5')?>", param, function(res) {
        ...
        function set_approve(rid,idc){
            if($('#approve-'+rid).val() != ""){
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('admin/register_training/set_approve_v5') ?>",
                    data: {
                        id: rid,
                        idc: idc,
