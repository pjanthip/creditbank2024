                                ...
                                <tbody>
                                    ...
                                    $cc=1;
                                        foreach ($register as $data) {
                                            ...
                                            $sql = "SELECT * FROM tb_register_member WHERE curriculum_id = 'C00001' AND register_status <> 0 AND register_datetime_record < '2023-02-01'";
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form id="form-<?php echo $data->training_register_id;?>" action="<?php echo site_url('admin/register_training/result');?>" method="post">
