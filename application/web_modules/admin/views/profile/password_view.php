                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="input-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="username-coor" id="username-coor" placeholder="Username" aria-label="Username" readonly aria-describedby="basic-addon4" value="<?php echo $data->coordinator_username;?>">
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $("#bt-update-password").click(function (e) {// เมื่อกดปุ่มบันทึกข้อมูล
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/profile/chk_pass') ?>",
                data: {
                    id: $("#username-coor").val(),
