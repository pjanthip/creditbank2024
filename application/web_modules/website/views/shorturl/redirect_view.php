...
<body class="stretched">
								...
								<div class="col-sm-8 col-lg-8">
									<div class="feature-box fbox-center fbox-light fbox-plain">
										...
										<div class="fbox-content">
											<h2><?php echo $url->url_name;?></h2>
											<p>กำลังพาท่านไปยังลิงค์ในอีก <span id="cooldown_time"></span> วินาที หรือ <a href="<?php echo $url->url_destination;?>">คลิกไปยังลิงค์ทันที</a></p>
										</div>
									</div>
								</div>
							</div>
    ...
    <script>
        ...
        var x = setInterval(function() {
            ...
            if(full_time < 0){
                clearInterval(x);
                window.location.href = "<?php echo $url->url_destination;?>";
            }
        }, 1000);
