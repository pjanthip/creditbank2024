...
{   
    ...
    public function get_date_register(){
        $reponse['start_register_date']='2023-02-01';
        $reponse['end_register_date']='2023-05-07';
    ...
    public function main_view()
    {
        ...
        $this->load->view('website/register/main_view', $reponse);
    ...
    public function load_form_upload()
    {
        ...
        $this->load->view('website/register/load_form_upload', $reponse);
    }
    ...
    public function getReason()
    {
        ...
        $sql_document = "SELECT
                        ...
                        FROM
                        tb_document
                        INNER JOIN tb_coordinator ON tb_document.admin_id = tb_coordinator.coordinator_id
                        ...
                        WHERE
                        tb_document.document_id = '$document_id' ";
        
        $reponse['tb_document'] = $this->db->query($sql_document)->row();

        $this->load->view('website/register/load_reason', $reponse);
    }
    ...
    public function update_document()
    {
        ...
        if (isset($_FILES["file"])) {
            ...
            if (!is_array($_FILES["file"]["name"])) { //single file
                ...
                $this->db->update('tb_document', $data_document, array('document_id' => $document_id));
    ...
    public function frm1()
    {
        ...
        $sql = "SELECT * FROM tb_register_member WHERE register_member_idcard = '$citizen_id' AND register_datetime_record >= '".$response['start_register_date']."' AND register_datetime_record <= '".$response['end_register_date']."' ORDER BY register_member_id ASC ";
        $reponse['register'] = $this->db->query($sql)->row();
        if($reponse['register']){

            $this->load->view('website/register/frm1_edit', $reponse);
            $this->load->view('website/register/include/footer', $reponse);
        }else{

            $this->load->view('website/register/frm1', $reponse);
            $this->load->view('website/register/include/footer', $reponse);
        }
    }
    ...
    public function search_curriculum()
    {
        ...
        $this->load->view('website/register/search_curriculum', $reponse);
    }
    ...
    public function frm2()
    {
        ...
        $this->load->view('website/register/include/header', $reponse);
        $this->load->view('website/register/include/navbar', $reponse);
        $this->load->view('website/register/frm2', $reponse);
        $this->load->view('website/register/include/footer2', $reponse);
    }
    ...
    function update_status_register()
    {
        ...
        if($this->db->update('tb_register_member', array('register_status' => '3'), array('register_member_id' => $register_member_id))){

            $sql = "SELECT * FROM tb_register_member WHERE register_member_id = '$register_member_id' ORDER BY register_member_id ASC ";
            $register = $this->db->query($sql)->row();
    ...
    public function frm3()
    {
        ...
        $this->load->view('website/register/include/header', $reponse);
        $this->load->view('website/register/include/navbar', $reponse);
        $this->load->view('website/register/frm3', $reponse);
        $this->load->view('website/register/include/footer', $reponse);
    }
    ...
    public function pay()
    {
        ...
        $this->load->view('website/register/pay', $reponse);
        //$this->load->view('website/register/include/footer', $reponse);
    ...
    public function complete()
    {
        ...
        $this->load->view('website/register/register_complete', $reponse);
        $this->load->view('website/register/include/footer', $reponse);
    }
    ...
    public function check_register()
    {
        ...
        if($checkValid == 1){
            ...
            if($chk_has==0){
                $sql = "SELECT * FROM tb_register_member WHERE tb_register_member.curriculum_id = 'C00001' AND register_datetime_record >= '".$response['start_register_date']."' AND register_datetime_record <= '".$response['end_register_date']."'";
            ...
            $sql = "SELECT * FROM tb_register_member WHERE  register_member_idcard = '$citizen_id' AND register_status in ('0', '3', '4', '5', '6') AND register_datetime_record >= '".$response['start_register_date']."' AND register_datetime_record <= '".$response['end_register_date']."'";
            $register = $this->db->query($sql)->row();
    ...
    public function regis_training_member()
    {
       ...
       if(empty($check_training)){
            ...
            $this->db->update('tb_register_member', array('register_status' => '4'), array('register_member_idcard' => $register_member_idcard));
    ...
    {   
       ...
       //  echo $this->db->insert_string('tb_register_member', $data);
        //exit();
        if( $this->db->insert('tb_register_member', $data)){

            $register_member_id = $this->db->insert_id();
            
            $tb_document_type = $this->db->get('tb_document_type')->result();
            ...
            foreach($tb_document_type as $item){
                ...
                $this->db->insert('tb_document', $document);
            }
    ...
    function line_notify(){
        ...
        if($function=="new"){
            ...
            $sql = "SELECT * FROM tb_register_member WHERE register_datetime_record >='2023-02-01' AND register_datetime_record<='2023-04-10'";
            ...
            $sql = "SELECT * FROM tb_document INNER JOIN tb_document_type ON tb_document.document_type_id = tb_document_type.document_type_id WHERE tb_document.document_id = '$did'";
            $document = $this->db->query($sql)->row();
            
            $content = "** UPLOAD **";
            $content .= "\n-----------------------------------";
            $content .= "\nเอกสาร : ".$document->document_type_name;
            $content .= "\nLink : ".site_url('assets/document/'.$document->document_file_name);
            $content .= "\n-----------------------------------";
            $content .= "\nผู้สมัคร : ".$member->prefix_name_full_th.$member->register_member_fname_th.' '.$member->register_member_lname_th;
            $content .= "\nเบอร์โทร : ".$member->register_member_phone;
            ...
            $sql = "SELECT * FROM tb_training_member WHERE 	training_register_id = 10";
            $no_member = $this->db->query($sql)->num_rows();

            $sql = "SELECT * FROM tb_training_member WHERE  training_member_idcard = '$idcard' AND  training_register_id='$regis_id'";
            $training = $this->db->query($sql)->row();

            $sql = "SELECT * FROM tb_register_member INNER JOIN tb_prefix_name ON tb_register_member.prefix_name_id = tb_prefix_name.prefix_name_id WHERE tb_register_member.register_member_idcard = '$idcard'";
            $member = $this->db->query($sql)->row();

            $sql = "SELECT * FROM tb_training_register WHERE training_register_id = '$regis_id'";
            ...
            $sql = "SELECT * FROM tb_training_member INNER JOIN tb_bank ON tb_training_member.bank_id = tb_bank.bank_id WHERE tb_training_member.training_member_id = '$training_id'";
            $training = $this->db->query($sql)->row();
            ...
            $content .= "\nเวลาชำระ : ".$date.' น.';
            $content .= "\n-----------------------------------";
            $content .= "\nPayment Slip : ".site_url('assets/document/slip/'.$training->training_member_slip);
        }
        $sMessage = $content;
    ...
    {       
       ...
       //  echo $this->db->insert_string('tb_register_member', $data);
        //exit();
        if( $this->db->update('tb_register_member', $data, ['register_member_id' => $register_member_id])){
