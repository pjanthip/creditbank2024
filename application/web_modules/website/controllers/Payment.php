...
{   
    ...
    public function main_view()
    {
        ...
        $this->load->view('website/payment/main_view', $reponse);
    ...
    public function Payment_view()
    {
        ...
        $sql = "SELECT * FROM tb_register_member_66 INNER JOIN tb_prefix_name ON tb_register_member_66.prefix_name_id = tb_prefix_name.prefix_name_id WHERE tb_register_member_66.register_member_idcard = '$register_member_idcard'";
        $reponse['member'] = $this->db->query($sql)->row();
        ...
        $this->load->view('website/register-66/include/header', $reponse);
        $this->load->view('website/register-66/include/navbar', $reponse);
        $this->load->view('website/payment/payment_view', $reponse);
        $this->load->view('website/register-66/include/footer', $reponse);
    }
    ...
    public function check_register()
    {
        ...
        if($checkValid == 1){
            ...
            $sql = "SELECT * FROM tb_register_member_66 WHERE  register_member_idcard = '$citizen_id' AND register_status = '6'";
            $register = $this->db->query($sql)->row();
