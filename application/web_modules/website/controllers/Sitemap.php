...
class Sitemap extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $reponse['sub_page']='SITEMAP';
        $reponse['title'] = $this->lang->line('nav_sitemap');
        $reponse['breadcrumb'] = [
            $this->lang->line('nav_sitemap') => ["url" => site_url('sitemap'), "active" => true]
        ];
        ...
        $this->load->view('website/sitemap/main_view',$reponse);
